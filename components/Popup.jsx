...
import { X, MessageSquare, Calendar, Phone, ArrowUpRight, Zap, Globe, ExternalLink,ShieldCheck, LayoutGrid } from "lucide-react";
        ...
        <div ref={dockRef} className="glass-dock pointer-events-auto">
          ...
          >
            ...
            <div className="flex flex-col mr-12">
               <span className="text-amber-500 text-[8px] font-black uppercase tracking-[0.5em] leading-none mb-1">Protocol</span>
               <span className="text-white text-[11px] font-bold tracking-[0.2em] uppercase">Prime Access</span>
            </div>
            ...
            <div className="lg:col-span-5 relative p-8 md:p-16 lg:p-20 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-white/5 bg-gradient-to-br from-black to-neutral-900/50">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6 lg:mb-10">
                   ...
                   <span className="text-amber-500 font-black uppercase tracking-[0.3em] lg:tracking-[0.5em] text-[8px] lg:text-[10px]">Elite Verified</span>
                </div>
                <h2 className="text-4xl md:text-5xl lg:text-7xl font-black uppercase tracking-tighter leading-[0.85] text-white">
                  Monopoly <br /> <span className="text-transparent bg-clip-text bg-gradient-to-b from-white to-neutral-700 italic">Prime.</span>
                </h2>
              </div>
              ...
              <div className="relative z-10 mt-10 lg:mt-0 space-y-6 lg:space-y-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4 lg:gap-6">
                  <a href="tel:+971588017015" className="group flex items-center gap-3 lg:gap-4">
                      ...
                      <span className="text-[10px] lg:text-sm font-bold uppercase tracking-widest text-white/60 group-hover:text-white">+971 58 801 7015</span>
                  </a>
                  <a href="mailto:info@monopolyprime.ae" className="group flex items-center gap-3 lg:gap-4">
                      <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-white/5 flex items-center justify-center text-amber-500">
                        <Globe size={14} />
                      </div>
                      <span className="text-[10px] lg:text-sm font-bold uppercase tracking-widest text-white/60 group-hover:text-white">monopolyprime.ae</span>
                  </a>
                </div>
                <p className="text-white/20 text-[8px] lg:text-[9px] font-black uppercase tracking-[0.4em] lg:tracking-[0.6em]">Dubai • Sharjah • London</p>
              </div>
            </div>
              ...
              <div className="max-w-md w-full mx-auto space-y-10 lg:space-y-14">
                ...
                <div className="space-y-6 lg:space-y-8">
                  <div className="text-center lg:text-left">
                    <span className="text-amber-500 font-black uppercase tracking-[0.4em] text-[8px] lg:text-[10px] mb-2 block">Transmission Protocol</span>
                    <h3 className="text-3xl lg:text-4xl font-black text-white uppercase tracking-tighter">
                      Connect <br className="hidden lg:block" /> <span className="text-white/20">Immediately.</span>
                    </h3>
                  </div>
                  ...
                  <button className="group relative w-full py-6 lg:py-8 bg-amber-500 text-black font-black uppercase tracking-[0.3em] lg:tracking-[0.5em] text-[10px] lg:text-xs rounded-2xl overflow-hidden shadow-lg transition-transform active:scale-[0.97]">
                      <span className="relative z-10 flex items-center justify-center gap-3 lg:gap-4">
                        <MessageSquare size={18} fill="currentColor" /> Message on WhatsApp
                      </span>
                  </button>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4">
                      <button className="flex flex-row lg:flex-col items-center justify-center gap-3 lg:gap-4 py-5 lg:py-8 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 transition-all">
                        ...
                        <span className="text-[8px] lg:text-[10px] font-black uppercase tracking-widest text-white/60">Book Viewing</span>
                      </button>
                      <button className="flex flex-row lg:flex-col items-center justify-center gap-3 lg:gap-4 py-5 lg:py-8 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 transition-all">
                        <LayoutGrid size={18} className="text-amber-500" />
                        <span className="text-[8px] lg:text-[10px] font-black uppercase tracking-widest text-white/60">Full Portfolio</span>
                      </button>
                  </div>
                </div>
                ...
                <div className="space-y-4 lg:space-y-6 pt-8 lg:pt-10 border-t border-white/5">
                  <span className="text-neutral-600 font-black uppercase tracking-[0.3em] text-[8px] block text-center lg:text-left">Market Channels</span>
                  <div className="grid grid-cols-2 gap-3 lg:gap-4">
                      <a href="#" className="flex items-center justify-between p-4 lg:p-6 bg-[#2c8444]/5 border border-[#2c8444]/20 rounded-xl lg:rounded-2xl hover:bg-[#2c8444]/10 transition-all">
                        <span className="text-white font-bold uppercase tracking-widest text-[9px] lg:text-[11px]">Bayut</span>
                        <ExternalLink size={12} className="text-white/40" />
                      </a>
                      <a href="#" className="flex items-center justify-between p-4 lg:p-6 bg-[#ff385c]/5 border border-[#ff385c]/20 rounded-xl lg:rounded-2xl hover:bg-[#ff385c]/10 transition-all">
                        <span className="text-white font-bold uppercase tracking-widest text-[9px] lg:text-[11px]">Dubizzle</span>
                        <ExternalLink size={12} className="text-white/40" />
                      </a>
                  </div>
                </div>
