...
const TitanMonolithFooter = () => {
  ...
  return (
    <footer ref={footerRef} className="bg-[#020202] pt-40 pb-12 px-6 lg:px-24 relative overflow-hidden border-t border-white/10">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-40">
          <div className="lg:col-span-8 footer-reveal">
            <h2 className="text-7xl md:text-[160px] font-black uppercase tracking-tighter leading-[0.75] mb-12">
              The <br /> <span className="text-white">Titan.</span>
            </h2>
            <div className="flex flex-wrap gap-8">
              ...
              <div className="flex items-center gap-6">
                <a href="#" className="w-12 h-12 rounded-full border border-white flex items-center justify-center text-white hover:bg-amber-500 hover:text-black transition-all">
                  <Instagram size={20} />
                </a>
                <a href="#" className="w-12 h-12 rounded-full border border-white flex items-center justify-center text-white hover:bg-amber-500 hover:text-black transition-all">
                  <Linkedin size={20} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-32 footer-reveal">
          ...
          <div className="bg-white/5 p-10 rounded-[3rem] border border-white/10 hover:border-amber-500/50 transition-colors">
            <h4 className="text-amber-500 font-black uppercase tracking-widest text-xs mb-8">Navigation</h4>
            <ul className="space-y-4">
              {navLinks.map((link) => (
                <li key={link.name}>
                  <a href={link.href} className="text-white font-bold uppercase tracking-widest text-sm hover:text-amber-500 flex items-center justify-between group">
          ...
          <div className="bg-white/5 p-10 rounded-[3rem] border border-white/10 hover:border-amber-500/50 transition-colors lg:col-span-2">
            <h4 className="text-amber-500 font-black uppercase tracking-widest text-xs mb-8">Direct Protocols</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="flex items-center gap-4 group cursor-pointer">
                  <Phone size={18} className="text-amber-500" />
                  <span className="text-white font-bold uppercase tracking-widest text-sm">+971 6 5XX XXXX</span>
                </div>
                <div className="flex items-center gap-4 group cursor-pointer">
                  <Mail size={18} className="text-amber-500" />
                  <span className="text-white font-bold uppercase tracking-widest text-sm">private@titan.ae</span>
                </div>
              </div>
          ...
          <div className="bg-amber-500 p-10 rounded-[3rem] flex flex-col justify-between text-black">
             ...
             <div>
                ...
                <p className="text-2xl font-black uppercase tracking-tighter">Operational</p>
             </div>
          </div>
        </div>
        ...
        <div className="pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-8 footer-reveal">
          <div className="flex items-center gap-8">
            <div className="flex items-center gap-2">
               ...
               <span className="text-[10px] font-black uppercase tracking-[0.4em] text-white/40">Market Node: SHJ-25.2</span>
            </div>
          ...
          >
            Ascend <ArrowUp size={16} className="group-hover:-translate-y-1 transition-transform" />
          </button>
        </div>
