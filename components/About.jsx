...
const AboutPage = () => {
        ...
        let ctx = gsap.context(() => {
            ...
            cards.forEach(card => {
                ...
                card.addEventListener("mouseleave", () => {
                    gsap.to(card.querySelector(".card-content"), { x: 0, y: 0, duration: 0.6 });
                });
            });
        }, containerRef);
        return () => ctx.revert();
    ...
    return (
        <main ref={containerRef} className="bg-[#020202] text-white overflow-hidden">
            ...
            <section className="relative h-screen flex flex-col justify-center px-6 lg:px-24 border-b border-white/5">
                ...
                <div className="max-w-5xl z-10">
                    ...
                    <h1 className="reveal-text text-7xl md:text-[160px] font-black tracking-tighter uppercase leading-[0.75] mb-12">
                        The <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-neutral-800 via-white to-neutral-800">Architects</span> <br /> of Value.
                    </h1>
                    <p className="reveal-text text-neutral-400 text-sm md:text-xl uppercase tracking-[0.5em] font-light max-w-2xl leading-relaxed">
                        Redefining the standard of elite real estate in Sharjah and across the Emirates.
                    </p>
                </div>
            ...
            <section className="relative h-[80vh] overflow-hidden">
                <img
                    ...
                    alt="Sharjah Skyline"
                    className="about-image w-full h-full object-cover grayscale brightness-50"
                />
                <div className="absolute inset-0 bg-gradient-to-b from-[#020202] via-transparent to-[#020202]" />

                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                        <span className="text-amber-500  font-bold tracking-[1em] uppercase text-xs mb-4 block ">Headquarters</span>
                        <h3 className="text-4xl md:text-6xl font-black uppercase tracking-tighter">Sharjah &bull; Dubai</h3>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
                        <div>
                            ...
                            <p className="reveal-text text-neutral-400 text-lg leading-relaxed max-w-lg border-l border-amber-500/30 pl-8">
                                We believe that real estate isn't just about square footage—it's about the precision of the transaction and the legacy of the location.
                            </p>
                        </div>
                        <div className="relative">
                            ...
                            <div className="absolute -bottom-10 -left-10 bg-amber-500 p-8 rounded-2xl hidden md:block">
                                <p className="text-black font-black text-4xl tracking-tighter">10k+</p>
                                <p className="text-black/60 text-[10px] uppercase font-bold tracking-widest">Managed Assets</p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-40 bg-amber-500 text-black px-6 text-center relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto">
                    <h4 className="text-[10px] font-black uppercase tracking-[0.5em] mb-8">Ready to Commence</h4>
            ...
            <footer className="bg-[#020202] py-12 px-6 lg:px-24 flex flex-col md:flex-row justify-between items-center opacity-30 gap-6">
                <p className="text-[10px] uppercase font-black tracking-[0.6em]">Dubai &bull; Sharjah &bull; London</p>
                <div className="flex items-center gap-2">
                    <MapPin size={12} className="text-amber-500" />
                    <span className="text-[10px] uppercase font-bold tracking-widest italic">Official Protocol HQ</span>
                </div>
            </footer>
